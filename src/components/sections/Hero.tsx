export const Hero = () => {
    return (
        <section className="grid grid-cols-1 h-96 bg-white place-content-center">
            <div>
                <figure aria-labelledby="emoji-description" className="text-center fluid-xl">
                    <figcaption id="emoji-description" className="visually-hidden sr-only">List of emojis symbolizing
                        various aspects
                    </figcaption>
