                ...
                <ul>
                    <li>
                        <Link href='https://linkedin.com/in/lsprr' rel="noreferrer noopener" target="_blank">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="#ffb300" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                strokeLinejoin="round" className="feather feather-linkedin" aria-hidden="true">
                                <path
                    ...
                    <li>
                        <Link href='https://github.com/lsprr' rel="noreferrer noopener" target="_blank">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="#ffb300" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                strokeLinejoin="round" className="feather feather-github" aria-hidden="true">
                                <path
